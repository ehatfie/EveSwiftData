...
struct ContentView: View {
    ...
    var body: some View {
        ...
        HStack {
            ...
            VStack {
                ShipFittingView(viewModel: ShipFittingViewModel(modelData: modelData))
                //detailView()
            }
        }.onAppear {
            //Task {
    ...
    func detailView() -> some View {
        VStack {
            ...
            HStack {
                ForEach([YamlFiles.groupIDs, YamlFiles.typeIDs, YamlFiles.categoryIDs], id: \.rawValue) { file in
...
//            }
    ...
    private func addItems(_ data: [TypeModel], to modelContext: ModelContext) async {
